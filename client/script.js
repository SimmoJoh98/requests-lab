...
// CODE HERE
sayHelloButton.addEventListener('mouseover', bgChanger)
function bgChanger(){
...
// CODE HERE
sayHelloButton.addEventListener('mouseout', bgUndo)
function bgUndo(){
...
function createFood(e){
    e.preventDefault()
    let foodInput = document.querySelector('#my-text-input')
    let body = {"newFood": foodInput.value}
    axios.post(`http://localhost:3000/food`, body).then(
        (res) => {
...
document.querySelector('#my-form'),addEventListener('submit', createFood)